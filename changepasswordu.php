  ...
  if(isset($_POST['submit']))
     {
	   ...
	   $cname=  protect($_POST['cname']);
           if(!preg_match("/^[a-zA-Z0-9]{5,}+$/",$pname))
               {
                 $ferr = "minimum 5 letters/number";
                 $a="";
               }
               else
               {
...
<div class="container" >
    ...
    <form method="post" action="changepasswordu.php">
          <table align="center">
		 ...
		 <tr><td></td><td><button class="btn btn-info" id="submit" type="submit" name="submit">Change password</button></td></tr>
          </table> 
      </form>
        <legend>
        </legend>
        
    <a href="usermain.php"><b>Go Back</b></a>
